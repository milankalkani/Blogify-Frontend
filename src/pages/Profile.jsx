...
const Profile = () => {
    const { user, updateProfile, uploadAvatar, getStats } = useAuth();
                        ...
                        <Formik
                            ...
                            onSubmit={async (values) => {
                                if (avatarPreview instanceof File) {
                                    const url = await uploadAvatar(avatarPreview);
                                    values.avatar = url;
                                }
                        ...
                        >
                            {({ setFieldValue }) => (
                                <Form className="space-y-5">
                                    ...
                                    <motion.button type="submit" className="w-full py-3 rounded-xl bg-blue-600 text-white">
                                        Save Changes
                                    </motion.button>
